...
const OurFeature = () => {
    return (
        <section>
            ...
            <div className="mt-10 mb-[800px] lg:mb-60 w-full bg-cover bg-center bg-no-repeat p-0 md:p-4 lg:p-10 h-[550px] rounded-xl" style={{ backgroundImage: "url('/feature-bg.png')" }}>
